...
//
// DO NOT hand-edit this file except for the values Tuner X owns (gains, CAN IDs,
// offsets, gear ratios). Regenerating from Tuner X overwrites everything here.
// Team-authored drivetrain constants belong in DriveConstants instead.
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
            ...
            .withKS(0.1).withKV(0.60).withKA(0)
    ...
    // This is NOT the desired max robot speed - see DriveConstants.kMaxSpeed
    // This needs to be tuned to your individual robot
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.32861328125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.081787109375);
